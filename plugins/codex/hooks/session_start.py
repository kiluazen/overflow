...
def main() -> int:
    ...
    context = (
        ...
        "2. First check the job is worth delegating at all. Writing the orders "
        "costs you roughly as much as writing about a thousand words of answer, so "
        "if the whole finished answer would be shorter than that, just write it "
        "here — measured, delegating a 550-word job cost more than doing it, and a "
        "1,900-word job cost noticeably less. Delegate substantial work.\n"

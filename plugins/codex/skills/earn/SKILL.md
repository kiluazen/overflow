...
3. Tell the user which order this task claimed in one sentence.
4. Perform the order yourself in this conversation. The user should see the
...
5. Produce the requested artifact, check it against the acceptance test, then
...
6. End by saying whether the requester received it. Do not claim another order

...
.job{display:grid;grid-template-columns:minmax(0,1fr) minmax(140px,205px) 148px;gap:22px;align-items:center;padding:18px 23px;border-top:1px solid var(--line)}
